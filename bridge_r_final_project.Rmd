...
We see a substantial drop between 2001 and 2002. Unfortunately the data is not more recent. I suspect this trend would continue.
...
The median age of 21 is lower than I might have thought. The mean is of course higher because the age distribution is skewed to the right (i.e., older), which can be reaffirmed by a simple boxplot:
...
This dataset has some interesting information. I wish it were more recent and a bit more detailed (e.g., the current binary labels of "Black/White" for race are absurdly broad.) Perhaps the most interesting statistic is the high proportion of male arrests relative to female.
